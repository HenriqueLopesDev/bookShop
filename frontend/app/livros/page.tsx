      ...
      <div className="bg-neutral-200 bg-[#e9e9e9] py-3 px-4 rounded-md h-[calc(100vh-196px)]">
        <div className="flex gap-3">
          <form className="flex w-full">
            ...
            />
            <button className="bg-blue-700 rounded-r-lg py-1 px-3 hover:bg-blue-600 duration-500">
              <MagnifyingGlass size={16} weight="bold" color="#fff" />
            </button>
          </form>
          <button className="bg-blue-700 py-1 px-3 rounded-md flex gap-2 items-center hover:bg-blue-600 duration-500">
            <span className="text-white font-medium font-poppins">Filtros</span>
            <Funnel size={20} weight="bold" color="#fff" />
          </button>
        </div>
      </div>
    </div>
